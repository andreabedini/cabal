...
replAction _flags _targetStrings _globalFlags =
...
--     -- here.
--     (buildCtx, compiler, progdb, replOpts', targets) <- withInstallPlan verbosity baseCtx'' $
...
--         return (buildCtx, toolchainCompiler, toolchainProgramDb, configureReplOptions & lReplOptionsFlags %~ (++ repl_flags), targets)
