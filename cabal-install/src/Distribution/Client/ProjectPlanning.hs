          ...
          where
            ...
            elabBuildOptions =
              LBC.BuildOptions
                ...
                , withDynExe = perPkgOptionFlag srcpkgPackageId False packageConfigDynExe
  ...
  configCommonFlags = do
    ...
    where
      ...
      configDependencies =
        ...
        | (WithStage _ cid, is_internal) <- elabLibDependencies elab
        , not is_internal
        ]
      ...
      configConstraints =
        case elabPkgOrComp of
          ElabPackage _ ->
            ...
            | (WithStage _ (ConfiguredId srcid _ _uid), _) <- elabLibDependencies elab
            ]
          ElabComponent _ -> []
