...
dependencySatisfiable
  ...
  (Dependency depName vr sublibs)
    ...
    where
      ...
      internalDepSatisfiableExternally =
        not (any (null . PackageIndex.lookupInternalDependency installedPackageSet pn vr) sublibs)
        ...
        maybe
          ...
          ( \ipi ->
              IPI.libVisibility ipi
                ...
                || pkgName (IPI.sourcePackageId ipi)
                == pn
          )
          maybeIPI
...
getInstalledPackages verbosity comp packageDBs progdb = do
  ...
  case compilerFlavor comp of
    GHC ->
      GHC.getInstalledPackages verbosity comp packageDBs' progdb
    GHCJS ->
      GHCJS.getInstalledPackages verbosity packageDBs' progdb
    UHC ->
      UHC.getInstalledPackages verbosity comp packageDBs' progdb
    HaskellSuite{} ->
